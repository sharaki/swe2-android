...
public class UserController {
	...
	public void login(String userName, String password) {
		...
		new Connection().execute(
				"http://yarb25ls.appspot.com/rest/LoginService", userName,
				password, "LoginService");
	}

	public void signUp(String userName, String email, String password) {
		new Connection().execute(
				"http://yarb25ls.appspot.com/rest/RegistrationService", userName,
				email, password, "RegistrationService");
	}
    public void searchService(String email){
        new Connection().execute(
                "http://yarb25ls.appspot.com/rest/sendrequestservice",
                email, "sendRequestService");
    }
    public void logOut (){
        new Connection().execute(
                "http://yarb25ls.appspot.com/social","logout");
    }
